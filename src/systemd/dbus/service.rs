// This code was autogenerated with `dbus-codegen-rust -s -g -d org.freedesktop.systemd1 -p /org/freedesktop/systemd1/unit/systemd_2dnetworkd_2eservice -o src/systemd/service.rs -f org.freedesktop.systemd1.Service`, see https://github.com/diwic/dbus-rs
use dbus;
  ...
  OrgFreedesktopSystemd1Service for blocking::Proxy<'a, C>
{
  ...
  fn get_processes(&self) -> Result<Vec<(String, u32, String)>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Service", "GetProcesses", ())
