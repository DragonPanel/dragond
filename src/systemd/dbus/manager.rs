  ...
  OrgFreedesktopSystemd1Manager for blocking::Proxy<'a, C>
{
  fn get_unit(&self, name: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetUnit", (name,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn get_unit_by_pid(&self, pid: u32) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetUnitByPID", (pid,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }
  ...
  fn stop_unit(&self, name: &str, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "StopUnit", (name, mode))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }
  ...
  fn get_job(&self, id: u32) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetJob", (id,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }
  ...
  > {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetJobAfter", (id,))
      .and_then(
        |r: (
          Vec<(
            u32,
  ...
  > {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetJobBefore", (id,))
      .and_then(
        |r: (
          Vec<(
            u32,
  ...
  > {
    self
      .method_call("org.freedesktop.systemd1.Manager", "ListJobs", ())
      .and_then(
        |r: (
          Vec<(
            u32,
  ...
  fn dump(&self) -> Result<String, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "Dump", ())
      .and_then(|r: (String,)| Ok(r.0))
  }
  ...
  fn enqueue_marked_jobs(&self) -> Result<Vec<dbus::Path<'static>>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "EnqueueMarkedJobs", ())
      .and_then(|r: (Vec<dbus::Path<'static>>,)| Ok(r.0))
  }

  fn list_unit_files(&self) -> Result<Vec<(String, String)>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "ListUnitFiles", ())
  ...
  fn get_default_target(&self) -> Result<String, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetDefaultTarget", ())
      .and_then(|r: (String,)| Ok(r.0))
  }
  ...
  fn get_dynamic_users(&self) -> Result<Vec<(u32, String)>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Manager", "GetDynamicUsers", ())
