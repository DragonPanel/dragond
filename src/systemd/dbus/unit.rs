// This code was autogenerated with `dbus-codegen-rust -s -g -d org.freedesktop.systemd1 -p /org/freedesktop/systemd1/unit/systemd_2dnetworkd_2eservice -o src/systemd/unit.rs -f org.freedesktop.systemd1.Unit`, see https://github.com/diwic/dbus-rs
use dbus;
  ...
  for blocking::Proxy<'a, C>
{
  fn start(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "Start", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn stop(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "Stop", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn reload(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "Reload", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn restart(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "Restart", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn try_restart(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "TryRestart", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }

  fn reload_or_restart(&self, mode: &str) -> Result<dbus::Path<'static>, dbus::Error> {
    self
      .method_call("org.freedesktop.systemd1.Unit", "ReloadOrRestart", (mode,))
      .and_then(|r: (dbus::Path<'static>,)| Ok(r.0))
  }
